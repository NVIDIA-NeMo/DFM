...
from nemo_vfm.physicalai.Cosmos.cosmos1.models.diffusion.nemo.inference.inference_utils import get_ctrl_batch_nemo, process_prompt, save_video
...
from nemo_vfm.diffusion.sampler.conditioner import VideoExtendConditionerControl
...
def setup_diffusion_pipeline(args):
    ...
    from nemo_vfm.diffusion.models.model import DiT7BControl2WorldConfig, DiT7BVideo2WorldConfig, DiTModel
