...
EXP_NAME=sbatch_wan_1.3B_pretrain_text2video_cicd_3000vids_weekly_example
...
NVTE_FUSED_ATTN=1 MASTER_ADDR=${MASTER_ADDR} MASTER_PORT=${MASTER_PORT} torchrun \
  ...
  dataset.path="/lustre/fsw/coreai_dlalgo_genai/huvu/data/nemo_vfm/datasets/cicd_tests/OpenVid-1M/OpenVidHD/OpenVidHD_part_1_3000vids_text2video_wds" \
