    ...
    inference_cfg = EasyDict(
        {
            ...
            "english_sample_neg_prompt": "Bright and vivid tones, overexposed, static, blurry details, subtitles, style, artwork, painting, image, still, overall grayish, worst quality, low quality, JPEG compression artifacts, ugly, defective, extra fingers, poorly drawn hands, poorly drawn face, deformed, disfigured, misshapen limbs, fused fingers, motionless image, messy background, three legs, crowded background, walking backward.",
        }
    )
