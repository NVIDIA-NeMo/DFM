...
torchrun --nnodes=\$SLURM_NNODES --nproc-per-node=\$NUM_GPUS --rdzv_backend=c10d --rdzv_endpoint=\$MASTER_ADDR:\$MASTER_PORT examples/automodel/pretrain/pretrain.py  -c examples/automodel/pretrain/cicd/wan21_cicd_nightly_video.yaml
EOF
echo "$CMD"
