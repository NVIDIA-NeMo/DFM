...
class TestDiTModelProvider:
    ...
    def test_configure_vae(self):
        ...
        with patch("dfm.src.megatron.model.dit.dit_model_provider.dynamic_import") as mock_dynamic_import:
            ...
            provider = DiTModelProvider(
                ...
                num_layers=self.num_layers,
                num_attention_heads=self.num_attention_heads,
                vae_module="dfm.src.common.tokenizers.cosmos.cosmos1.causal_video_tokenizer.CausalVideoTokenizer",
            ...
            mock_dynamic_import.assert_called_once_with(
                "dfm.src.common.tokenizers.cosmos.cosmos1.causal_video_tokenizer.CausalVideoTokenizer"
            )
