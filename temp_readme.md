...
```
hub/
Γö£ΓöÇΓöÇ models--nvidia--Cosmos-1.0-Diffusion-7B-Text2World/
Γö£ΓöÇΓöÇ models--nvidia--Cosmos-1.0-Diffusion-7B-Video2World/
ΓööΓöÇΓöÇ models--nvidia--Cosmos-1.0-Tokenizer-CV8x8x8/

multicamera/
Γö£ΓöÇΓöÇ video_camera_embeddings_v0_camera_front_tele_30fov.pt
Γö£ΓöÇΓöÇ video_camera_embeddings_v0_camera_rear_tele_30fov.pt
Γö£ΓöÇΓöÇ video_camera_embeddings_v0_camera_front_wide_120fov.pt
Γö£ΓöÇΓöÇ video_neg_prompt_embeddings_v0.pt
Γö£ΓöÇΓöÇ video_camera_embeddings_v0_camera_cross_left_120fov.pt
Γö£ΓöÇΓöÇ video_camera_embeddings_v0_camera_cross_right_120fov.pt
Γö£ΓöÇΓöÇ video_camera_embeddings_v0_camera_rear_left_70fov.pt
ΓööΓöÇΓöÇ video_camera_embeddings_v0_camera_rear_right_70fov.pt
```
