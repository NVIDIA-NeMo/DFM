...
from dfm.src.megatron.model.reve.flow_matching.flow_pipeline import FlowPipeline


logger = logging.getLogger(__name__)


def reve_data_step(qkv_format, dataloader_iter):
...
class ReveForwardStep:
    ...
    def __call__(
        ...
        with straggler_timer(bdata=True):
            batch = reve_data_step(qkv_format, data_iterator)
