...
class HunyuanVideoProcessor(BaseVideoProcessor):
    ...
    def load_models(self, model_name: str, device: str) -> Dict[str, Any]:
        ...
        print(f"[HunyuanVideo] Loading pipeline from {model_name}...")
        ...
        print("[HunyuanVideo] Models loaded successfully!")
    ...
    def encode_video(
        ...
        **kwargs,
        ...
        Args:
            ...
            deterministic: If True, use sample (HunyuanVideo uses sample by default)
